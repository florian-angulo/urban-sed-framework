...
parser.add_argument('-g', '--group', required=True, type=str, help="Group to create in the hdf5 file")
parser.add_argument('-f', '--folder', type=str, required=True, help= 'Path to audio folder')
